...
for jk in xrange(9):
	...
	model.add(Convolution2D(8, 3, 3,input_shape=(1, img_rows, img_cols),W_regularizer=l2(l2=0.001),init='he_normal'))
	model.add(Activation('relu'))

	model.add(Convolution2D(8, 3, 3,W_regularizer=l2(l2=0.001),init='he_normal'))
	model.add(Activation('relu'))
	...
	model.add(Flatten())
	model.add(Dense(10,W_regularizer=l2(l2=0.001),init='he_normal)))
	model.add(Activation('relu'))
