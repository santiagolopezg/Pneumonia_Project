...
for jk in xrange(9):
	...
	model.add(Convolution2D(8, 8, 8,
		                border_mode='valid',
		                input_shape=(1, img_rows, img_cols),subsample = (4,4),W_regularizer=l1l2(l1 = 0.01,l2=0.001),init='he_normal'))
	model.add(Activation('relu'))
	model.add(MaxPooling2D(pool_size=(nb_pool, nb_pool)))

	model.add(Convolution2D(8, 3, 3,W_regularizer=l1l2(l1 = 0.01,l2=0.001),init='he_normal'))
	model.add(Activation('relu'))
	model.add(MaxPooling2D(pool_size=(nb_pool, nb_pool)))

	model.add(Convolution2D(16, 3, 3,W_regularizer=l1l2(l1 = 0.01,l2=0.001),init='he_normal'))
	model.add(Activation('relu'))
	model.add(MaxPooling2D(pool_size=(nb_pool, nb_pool)))
