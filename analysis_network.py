...
We do this for all the networks and only safe the best 3 networks into the file: analyze_networks_2100_80_deform.pkl
...
os.chdir("/home/santiago/Desktop/neural-networks-and-deep-learning-master/new_net_something_l1")
...
h = open('analyze_networks_2100_80_deform.pkl','wb')
