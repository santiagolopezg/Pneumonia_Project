...
class ConvPoolLayer():
    ...
    def __init__(self,filter_shape,image_shape,w,b, poolsize=(2, 2), activation_fn=sigmoid):
...
#######################################
class ConvLayer():
    def __init__(self,filter_shape,image_shape,w,b, activation_fn=sigmoid):
...
class FullyConnectedLayer():
    ...
    def __init__(self, n_in, n_out,w,b, activation_fn=sigmoid, p_dropout=0.0):
        self.n_in = n_in
        self.n_out = n_out
        self.activation_fn = activation_fn
...
class SoftmaxLayer():
    ...
    def __init__(self, n_in, n_out,w,b, p_dropout=0.0):
        self.n_in = n_in
        self.n_out = n_out
        self.p_dropout = p_dropout
        # Initialize weights and biases
